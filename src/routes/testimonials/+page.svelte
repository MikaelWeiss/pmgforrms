<svelte:head>
	<title>Testimonials - Strive Planner</title>
...
<section class="py-16 bg-gradient-to-br from-blue-50 to-indigo-100">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
		<h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
			User<br />
			<span class="text-blue-600">Testimonials</span>
		</h1>
		<p class="text-xl text-gray-600 max-w-3xl mx-auto">
			Real stories from people who are living more intentionally with Strive Planner
		</p>
	</div>
</section>
	...
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<div class="mt-16 text-center">
			...
			<p class="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
				These are just a few of the many stories from users who have transformed their lives with Strive Planner. 
				Whether you're a returned missionary, busy professional, or someone seeking more purpose, 
				you'll find a community of like-minded individuals committed to intentional living.
			</p>
